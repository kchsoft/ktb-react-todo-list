...
const ToDoItem = ({toDo}) => {
  const {completeCheck} = useContext(ToDoListContext)
  ...
  return (
    <div className={ToDoItemStyles['todo-item']}>
      <input className={ToDoItemStyles['complete-box']} type="checkbox" onChange={handleCompleteCheck} checked={toDo.complete}/>
